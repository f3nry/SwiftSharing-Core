...
<div class="interactionLinksDiv">
	...
	<a class="modal_link" href="#remove_friend" title="Remove <?php echo $member->getName() ?> as a Friend">Remove
		Friend</a>
	<?php endif; ?>
	<?php if ($member->id == Session::instance()->get('user_id')): ?>
	<a class="modal_link"
	   href="#friend_requests"><?php echo Model_FriendRequest::getCountRequestsTo($member->id, true) ?></a>
	<?php endif; ?>
...
<div id="container2">
	...
	<div class="content wall">
		...
		<div class="form">
			...
			<div style="display:none;" id="username"><?php echo $member->username ?></div>
			<form action="/ajax/feed/new" id="share" method="post" enctype="multipart/form-data">
				<textarea name="text" cols="30" rows="3" style="width: 445px" id="sharetext"
				          placeholder="<?php if ($member->id == Session::instance()->get('user_id')): ?>Say something <?php echo $member->firstname ?>...<?php else: ?>Write on <?php echo $member->firstname ?>'s profile<?php endif; ?>"></textarea><br/>
	...
	<div class="content info">
		<div class="parts">
			...
			<p class="smalltxt"><a
							href="http://facebook.com/<?php echo strip_tags(@$member->facebook); ?>"><?php echo strip_tags(@$member->facebook); ?></a>
			</p>
			<?php endif; ?>
			...
			<p class="smalltxt"><a
							href="http://youtube.com/<?php echo strip_tags(@$member->youtube) ?>"><?php echo strip_tags(@$member->youtube); ?></a>
			</p>
			<?php endif; ?>
			...
			<p class="infotxt"><a
							href="http://<?php echo strip_tags(@$member->website); ?>"><?php echo strip_tags(@$member->website) ?></a>
			</p>
			<?php endif; ?>
		</div>
	</div>
	...
	<div class="content profile_photos" style="width:478px;display:none;">
		...
		<div class="">
			<div class="album_photo_previous">
				...
				<?php if ($previous): ?>
				<a href="/photos/<?php echo $photo->previous() ?>"><img src="/content/images/notifications/left_arrow.jpg"
				                                                        style="padding:0"/></a>
				<?php endif; ?>
			</div>
			...
			<div class="album_photo_next">
				<?php $next = $photo->next(); ?>
				<?php if ($next): ?>
				<a href="/photos/<?php echo $photo->next() ?>"><img src="/content/images/notifications/right_arrow.jpg"
				                                                    style="padding:0"/></a>
				<?php endif; ?>
			</div>
		</div>
