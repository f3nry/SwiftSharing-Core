                        ...
                        <table width="700" align="center" cellpadding="10" cellspacing="0" style="border:#999 1px solid; background-color:#FBFBFB;">
                            <form action="/profile/edit" method="post" enctype="multipart/form-data">
                                <tr>
                                    ...
                                    <td width="471">
                                        <input name="music" type="text" class="formFields" id="musicField" value="<?php echo @$member->music ?>" size="60" maxlength="160" /></td>
                                    <td width="56" rowspan="3" valign="top"><input name="updateBtn3" type="submit" value="Update" />
                                ...
                                <tr>
                                    <td>Movies:</span></td>
                                    <td>
                                        <input name="movies" type="text" class="formFields" id="movieField" value="<?php echo @$member->movies ?>" size="60" maxlength="160" /></td>
                                </tr>
                                <tr>
                                    <td>TV:</span></td>
                                    <td>
                                        <input name="tv" type="text" class="formFields" id="tvField" value="<?php echo @$member->tv ?>" size="60" maxlength="160" /></td>
                                </tr>
                                <tr>
                                    <td>Books:</span></td>
                                    <td>
                                        <input name="books" type="text" class="formFields" id="bookField" value="<?php echo @$member->books ?>" size="60" maxlength="160" /></td>
                                </tr>
                            </form>
                        </table>
                </div>
